...
namespace Lumina_Hospital.Migrations
{
    ...
    [Migration("20231220130349_AddDonateSectionTable")]
    partial class AddDonateSectionTable
    {
            ...
            modelBuilder.Entity("Lumina_Hospital.Entities.AboutSection.AboutSection", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2023, 12, 20, 17, 3, 48, 813, DateTimeKind.Local).AddTicks(1729),
            ...
            modelBuilder.Entity("Lumina_Hospital.Entities.DonateSection.DonateSection", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2023, 12, 20, 17, 3, 48, 813, DateTimeKind.Local).AddTicks(1742),
            ...
            modelBuilder.Entity("Lumina_Hospital.Entities.VideoSection.Video", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2023, 12, 20, 17, 3, 48, 813, DateTimeKind.Local).AddTicks(1572),
                            IsDelete = false,
            ...
            modelBuilder.Entity("Lumina_Hospital.Entities.VideoSection.VideoTitle", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2023, 12, 20, 17, 3, 48, 813, DateTimeKind.Local).AddTicks(1675),
                            IsDelete = false,
                        ...
                        {
                            Id = 2,
                            CreateAt = new DateTime(2023, 12, 20, 17, 3, 48, 813, DateTimeKind.Local).AddTicks(1677),
                            IsDelete = false,
                        ...
                        {
                            Id = 3,
                            CreateAt = new DateTime(2023, 12, 20, 17, 3, 48, 813, DateTimeKind.Local).AddTicks(1678),
                            IsDelete = false,
